...
const About = () => {
    return (
        <section id="about" className="container relative items-center w-full px-5 pt-10 pb-5 mx-auto mt-12 mb-12 md:mt-24">
            <div className="w-full px-4 ml-auto mr-auto md:w-6/12 ">
                <h3 className="text-3xl bg-clip-text text-black text-center title md:text-left">
                    ¿Quiénes somos?
                </h3>
            ...
            <div className="mx-auto md:w-4/12 aspect-w-16 aspect-h-9">
                <iframe
